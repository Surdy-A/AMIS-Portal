...
var ExaminationList = map[int]string{
	0: "Choose Exam",
	1: "JSS1",
	2: "JSS2",
}
...
type GradingExamination struct {
	gorm.Model
	UserID     uint
	User       models.User
	ExamType   string `form:"exam_type"  json:"exam_type" binding:"required,min=3,max=100"`
	SchoolCode string `form:"school_code" json:"school_code" binding:"required"`
	...
	LGA        string `form:"lga" json:"lga" binding:"required"`
}

type StudentGradingExamInfo struct {
	GradingExamination
	Quota         int       `form:"quota" json:"quota"`
	LastName      string    `form:"last_name" json:"last_name"`
	FirstName     string    `form:"first_name" json:"first_name"`
	StateOfOrigin string    `form:"state_of_origin" json:"state_of_origin"`
	LGA           string    `form:"lga" json:"lga"`
	Gender        string    `form:"gender" json:"gender"`
	Added         time.Time `form:"added" json:"added"`
}

var LGA = map[string][]string{
	"Abia": {
		"Aba North",
		"Aba South",
		"Arochukwu",
