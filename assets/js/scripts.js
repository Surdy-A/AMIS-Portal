...
// let schoolID = "";
// function deleteFunc() {
//   var tag = document.getElementById("schoolDetails");
//   console.log(tag);
//   schoolName = tag.getAttribute("schoolName");
//   schoolID = tag.getAttribute("schoolID");
//   //alert(schoolName);
//   alert(schoolID);
//   document.getElementById("modalTitle").setAttribute("schoolName", schoolName);
//   document.getElementById("deleteID").setAttribute("schoolID", schoolID);
// }
